...
public class RelatorioController {
    ...
    @GetMapping("/faturamento") public Map<String,Object> faturamento(
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate inicio,
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate fim) { return service.faturamento(inicio, fim); }
    @GetMapping("/diarias") public Map<String,Object> diarias(
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate inicio,
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate fim) { return service.diarias(inicio, fim); }
    @GetMapping("/restaurante") public List<Map<String,Object>> restaurante(
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate inicio,
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate fim) { return service.restaurante(inicio, fim); }
